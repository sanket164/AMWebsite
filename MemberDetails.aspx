                ...
                <div class="member-detail common-padding">
                    <div class="col-md-3">
                        ...
                        <div class="prof-second">
                            ...
                            <div runat="server" id="lastLogin_div" style="display: none;">
                                <p>
                    ...
                    <div style="color: blue; font-weight: bold;" runat="server" id="div_UpdateMSG">
                        ...
                        <p runat="server" id="EditMsg" visible="false">Your profile under process, Your profile Already Edited wait for Admin active</p>
                    </div>
                    <div class="col-md-9">
                                            ...
                                            <div class="col-md-12">
                                                <div class="prof-details">
                                                    <p>
                                                        ...
                                                        <%--<asp:Literal ID="lblMySelf" runat="server"></asp:Literal>--%>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
